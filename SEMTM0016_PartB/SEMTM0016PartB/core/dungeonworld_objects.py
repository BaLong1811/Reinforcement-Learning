...
class Orc(MazeObject):
    ...
    def __init__(self, pos, image_id):
        ...
        # MODIFY
        im = Image.open("images_new/orc/orc_{}.png".format(str(image_id).zfill(3))) 
        im = im.rotate(90)  # Rotate 90 degrees clockwise
...
class Wingedbat(MazeObject):
    ...
    def __init__(self, pos, image_id):
        ...
        im = Image.open(
            ...
            "images_new/wingedrat/wingedrat_{}.png".format(str(image_id).zfill(3)) 
        )
        im = im.rotate(90)  # Rotate 90 degrees clockwise
        self.image = np.array(im)
        im.close()
...
class Lizard(MazeObject):
    ...
    def __init__(self, pos, image_id):
        ...
        im = Image.open("images_new/lizard/lizard_{}.png".format(str(image_id).zfill(3))) 
        im = im.rotate(90)  # Rotate 90 degrees clockwise
        self.image = np.array(im)
        im.close()
